    ...
    <details className={styles["schedule-box__details"]}>
      <summary className={styles["schedule-box__summary"]}>
        ...
        <div className={styles["schedule-box__icon-container"]}>
          <ScheduleIcon width={iconSize} height={iconSize} />
          <time className={styles["schedule-box__time"]}>
            {formatDate(startDate)}
          </time>
        </div>
        {place && (
          <div className={styles["schedule-box__icon-container"]}>
            <LocationOnIcon width={iconSize} height={iconSize} />
            <p>{place}</p>
          </div>
        )}
      </summary>
      ...
      ></article>
      {images && (
        <div className={styles["schedule-box__image-set"]}>
          {images.map((props, index) => (
            <img src={props.image.url} alt={props.alt} key={index.toString()} />
          ))}
        </div>
      )}
    </details>
